...
DOCUMENTATION = r'''
---
module: bigip_sslo_layer3_service
...
options:
  name:
    description:
      - Specifies the name of the layer 3 security service. Configuration auto-prepends "ssloS_" to service.
...
name:
  description:
    - Changed name of layer 3 inline service.
  type: str
  sample: layer3a
devicesTo:
...
devicesFrom:
  ...
  contains:
    vlan:
       ...
       type: str
       sample: /Common/layer3-from-vlan
    interface:
...
devices:
  description:
    - Changed list of IP listeners for layer 3 inlines services.
  type: list
  sample: - 198.19.64.30
          - 198.19.64.31
state:
...
ipFamily:
  description:
    - Changed ipFamily value of layer 3 services.
  type: str
  sample: ipv4
monitor:
  description:
...
class ModuleManager(object):
    ...
    def update_json(self, operation):
        ...
        if self.want.ipFamily == "ipv4":
            ...
            self.config["inputProperties"][2]["value"]["customService"]["managedNetwork"]["ipv4"]["serviceType"] = "L3"
            ...
            self.config["inputProperties"][2]["value"]["customService"]["managedNetwork"]["ipv6"]["serviceType"] = "L3"
