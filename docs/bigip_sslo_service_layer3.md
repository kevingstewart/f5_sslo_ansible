...
| name | yes |  |  | [string]<br />The name of the security service (ex. layer3_1) |
...
| devices | yes |  |  | [list]<br />A list of device IP addresses. These will be addresses in the to-service IP subnet |
